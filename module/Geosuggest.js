...
exports.GEOCODE_API = exports.PLACES_API = undefined;
...
var PLACES_API = exports.PLACES_API = 'places',
    GEOCODE_API = exports.GEOCODE_API = 'geocode';
...
var Geosuggest = function (_React$Component) {
  ...
  function Geosuggest(props) {
    ...
    _this.handleGoogleResponse = function (suggests) {
      _this.setState({ isLoading: false });
      _this.updateSuggests(suggests || [], // can be null
      function () {
  ...
  _createClass(Geosuggest, [{
    ...
    value: function searchSuggests() {
      ...
      this.setState({ isLoading: true }, function () {
        switch (_this2.props.api) {
          case GEOCODE_API:
            _this2.geocoder.geocode({
              address: options.input,
              bounds: options.bounds
            }, function (items) {
              _this2.handleGoogleResponse(items.map(function (item) {
                return Object.assign(item, { description: item.formatted_address });
              }));
            });
            break;
          default:
            _this2.autocompleteService.getPlacePredictions(options, _this2.handleGoogleResponse);
        }
      });
    }
